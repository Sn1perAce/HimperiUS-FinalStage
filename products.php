...
<html lang="en">
  ...
  <head>
    ...
    <title>HimperiUS - Página de Produtos</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="inner-content">
                        <h2>Dê uma olhada em nossos produtos!</h2>
                        <span>Incríveis &amp; produtos pelo melhor preço.</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading">
                        ...
                        <span>Lista dos últimos produtos.</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="item">
            <div class="thumb">
                <div class="hover-content">
                    <ul>
                        <!-- Aqui você ajusta o link para apontar para single-product.php com o ID do produto -->
                        <li><a href="single-product.php?id=<?php echo $row['id']; ?>"><i class="fa fa-eye"></i></a></li>
                        <!-- Links para outros recursos como favoritar ou adicionar ao carrinho -->
                        <li><a href="#"><i class="fa fa-star"></i></a></li>
                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                    </ul>
                </div>
                <img src="product-images/<?php echo $row['imagem']; ?>" alt="<?php echo $row['nome']; ?>" style="width: 300px; height: 400px;">
            </div>
            ...
            <div class="col-lg-12">
                <div class="pagination">
                    <ul>
                        ...
                        $sql_total = "SELECT COUNT(id) AS total FROM produtos";
